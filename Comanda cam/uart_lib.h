...
#ifndef BAUDRATE_UART0
#error You must define BAUDRATE for UART0 in config.h
#endif

#ifndef BAUDRATE_UART1
#error You must define BAUDRATE for UART1 in config.h
#endif
...
#define Uart0_set_baudrate(bdr)        ( UBRR0H = (U8)((((U32)FOSC*1000L)/((U32)bdr*16)-1)>>8),\
                                        UBRR0L = (U8)(((U32)FOSC*1000 )/((U32)bdr*16)-1)    )

#define Uart0_set_TXB8()               (UCSR0B |= (1<<TXB80))
#define Uart0_clear_TXB8()             (UCSR0B &= ~(1<<TXB80))
#define Uart0_enable_tx()              (UCSR0B |= (1<<TXEN0))
#define Uart0_enable_rx()              (UCSR0B |= (1<<RXEN0))
#define Uart0_disable_tx()             (UCSR0B &= ~(1<<TXEN0))
#define Uart0_disable_rx()             (UCSR0B &= ~(1<<RXEN0))
#define Uart0_enable_mpcm()            (UCSR0A |= (1<<MPCM0))
#define Uart0_disable_mpcm()           (UCSR0A &= ~(1<<MPCM0))
#define Uart0_tx_complet()             (UCSR0A & MSK_UART_TX_COMPLET)

#define Uart0_clear_flag_tx()          (UCSR0A |= (1<<TXC0))
#define Uart0_enable_9bit()            (UCSR0B |= (1<<UCSZ02), UCSR0C |= ((1<<UCSZ01) | (1<<UCSZ00)))
#define Uart0_enable_8bit()            (UCSR0B &= ~(1<<UCSZ02), UCSR0C |= ((1<<UCSZ01) | (1<<UCSZ00))) 
#define Uart0_enable_2stop()           (UCSR0C |= (1<USBS0))
#define Uart0_enable_1stop()           (UCSR0C &= ~(1<USBS0))
#define Uart0_enable_even_parity()     (UCSR0C |= (1<UPM01), UCSR0C &= ~(1<<UPM00)) 
#define Uart0_enable_odd_parity()      (UCSR0C |= ((1<UPM01) | (1<<UPM00)) 
#define Uart0_disable_parity()         (UCSR0C &= ~((1<UPM01) | (1<<UPM00)))

#define Uart0_enable()                 (UCSR0B|=MSK_UART_ENABLE_RX|MSK_UART_ENABLE_TX)
#define Uart0_tx_ready()               (UCSR0A&MSK_UART_DRE)
#define Uart0_send_byte(ch)            (UDR0=ch)
#define Uart0_rx_ready()               (UCSR0A&MSK_UART_RX_DONE)
#define Uart0_get_byte()               (UDR0)

#define Uart0_enable_it_rx()           (UCSR0B|=MSK_UART_ENABLE_IT_RX)
#define Uart0_enable_it_tx()           (UCSR0B|=MSK_UART_ENABLE_IT_TX)
#define Uart0_disable_it_rx()          (UCSR0B&=~MSK_UART_ENABLE_IT_RX)
...
#define Uart1_enable_mpcm()            (UCSR1A |= (1<<MPCM0))
#define Uart1_disable_mpcm()           (UCSR1A &= ~(1<<MPCM0))
#define Uart1_tx_complet()             (UCSR1A & MSK_UART_TX_COMPLET)
...
#define Uart_rx1_ready()               (UCSR1A&MSK_UART_RX_DONE)
